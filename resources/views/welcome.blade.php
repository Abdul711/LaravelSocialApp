...
<!-- Mirrored from social.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Jun 2025 13:22:10 GMT -->
<head>
        ...
        <!-- Story END -->
				...
				<div class="card card-body">
					<div class="d-flex mb-3">
						...
						<form class="w-100" method="POST">
							<textarea class="form-control pe-4 border-0" rows="2" name="post" data-autoresize placeholder="Share your thoughts..."></textarea>
				...
				<div class="card">
					...
					<div class="card-footer border-0 d-flex justify-content-between align-items-center">
						...
						<a class="btn btn-primary-soft btn-sm" href="#" download> Download now </a>
					</div>
					<!-- Card footer END -->
...
<!-- Mirrored from social.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Jun 2025 13:22:42 GMT -->
</html>